...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary *)attributeDict {
    ...
    }else if ([elementName isEqualToString:kHCPConfigFileXmlTag2]) {
        [self parseConfigUrl2:attributeDict];
    }else if ([elementName isEqualToString:kHCPConfigFileXmlTag3]) {
        [self parseConfigUrl3:attributeDict];
...
- (void)parseConfigUrl2:(NSDictionary *)attributeDict {
    _xmlConfig.configUrl2 = [NSURL URLWithString:attributeDict[kHCPConfigFileUrlXmlAttribute]];
}
- (void)parseConfigUrl3:(NSDictionary *)attributeDict {
    _xmlConfig.configUrl3 = [NSURL URLWithString:attributeDict[kHCPConfigFileUrlXmlAttribute]];
}
